...
export async function getAboutPost(preview) {
  const params = {
    limit: 'all',
    include: 'authors, tags',
    order: 'published_at DESC',
...
export async function getHeroPost(preview) {
  const params = {
    limit: 'all',
    include: 'authors, tags',
    order: 'published_at DESC',
...
export async function getContactPost(preview) {
  const params = {
    limit: 'all',
    include: 'authors, tags',
    order: 'published_at DESC',
...
export async function getTabPosts(preview, tag) {
  const params = {
    limit: 'all',
    include: 'authors, tags',
    order: 'published_at DESC',
